...
[![Website](https://img.shields.io/badge/Website-ryan201212212.github.io-25B35EFF?style=for-the-badge&logo=github&logoColor=white)](https://raeyoung.github.io)
...
```python
class Raeyoung Chang:
    def __init__(self):
        self.role = "AI Master`s Student @ Sogang University"
        self.education = ["M.S. Computer Science & engineering @ Sogang Univ. [BK21] full-ride scholarship, 2024.2 ~ Now",
                         "Graduate Research @ University of Toronto, Selected by the Ministry of Science and ICT, Republic of Korea, for an AI research dispatch program, 2025.01~2025.07"]
        self.research_interests = ["Agentic AI Systems", 
                                   "Anomaly Detection",
                                   "RAG",
                                   "Time-Series Analysis"]
        self.currently_working_on = "Multi-Agent system and RAG"
```

- 🔭 **Currently:** Bigdata processing & Database Lab at Sogang University
- 🎓 **Background:** M.S. in Computer Science (GPA: 4.24/4.5) with research experience at UofT
